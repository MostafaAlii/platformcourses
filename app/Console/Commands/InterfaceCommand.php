...
class InterfaceCommand extends Command {
    ...
    public function getSingularClassName($name) {
        return ucwords(Pluralizer::singular($name) . 'Repository');
    }
    ...
    public function getSourceFilePath() {
        return base_path('App\\Repositories\\Contracts') .'\\' .$this->getSingularClassName($this->argument('name')) . 'Interface.php';
    }
