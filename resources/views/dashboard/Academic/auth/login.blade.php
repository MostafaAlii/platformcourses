...
@section('pageTitle')
    {{ trans('dashboard/auth.academic_auth_form_title') }}
@endsection
...
@section('content')
    ...
    <div class="p-10 d-flex flex-center flex-column flex-column-fluid pb-lg-20">
        ...
        <div class="p-10 mx-auto rounded shadow-sm w-lg-500px bg-body p-lg-15">
            ...
            <form class="form w-100" novalidate="novalidate" method="POST" id="kt_sign_in_form" action="{{route('academic.post.login')}}">
                @csrf
                <!--begin::Heading-->
                <div class="mb-10 text-center">
                    <!--begin::Title-->
                    <h1 class="mb-3 text-dark">{{ trans('dashboard/auth.academic_auth_form_title') }}</h1>
                    <!--end::Title-->
                </div>
                <!--begin::Heading-->
                <!--begin::Input group-->
                ...
                <div class="mb-10 fv-row">
                    ...
                    <div class="mb-2 d-flex flex-stack">
                        ...
                        <!--end::Label-->
                        <!--begin::Link-->
                        <a href="{{ route('academic.forgot.password') }}" class="link-primary fs-6 fw-bolder">{{ trans('dashboard/auth.forgot_password') }}</a>
                        <!--end::Link-->
                    </div>
                    <!--end::Wrapper-->
                    <!--begin::Input-->
