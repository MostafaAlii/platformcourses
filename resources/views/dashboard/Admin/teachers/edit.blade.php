...
@section('content')
    ...
    <div class="card">
        <form class="form" method="POST" action="{{ route('admin.teachers.update',$teacher->id) }}">
            @method('put')
            @csrf
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    value="{{ old('email', isset($teacher) ? $teacher->email : '') }}" />
                ...
                <div class="form-group">
                    ...
                    <div class="checkbox-list">
                        <label class="checkbox">
                            ...
                            {{ old('status', isset($teacher->status))  ? 'checked' : '' }} />
                            <span></span>
                            Active
                        </label>
                        <label class="checkbox">
